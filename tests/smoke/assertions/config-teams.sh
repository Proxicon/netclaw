...
assert_field '.Teams.TenantId' '11111111-1111-1111-1111-111111111111' "$config_json" || :
assert_field '.Teams.ClientId' '22222222-2222-2222-2222-222222222222' "$config_json" || :
assert_field '.Teams.BotId' '33333333-3333-3333-3333-333333333333' "$config_json" || :
